...
from Constants import ENVIRONMENT_PATH, GRAPH_DIST_PATH, UTILITIES_PATH, BATCH_SIZE, INFINITY, WEIGHTS_PATH
...
if __name__ == '__main__':
    ...
    my_weights = np.load(WEIGHTS_PATH, allow_pickle=True)
